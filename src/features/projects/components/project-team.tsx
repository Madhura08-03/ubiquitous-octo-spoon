      ...
      <div className="rounded-2xl border border-border bg-card p-6 space-y-4 shadow-2xs">
        <div className="flex items-center justify-between border-b border-border pb-3">
          ...
          <Link
            ...
            className="text-xs font-semibold gap-1 px-3 py-1.5 rounded-lg border border-border bg-card hover:bg-muted text-foreground inline-flex items-center"
          >
            <span>View Mentor Dossier</span>
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-sm font-bold text-foreground">
                Registered Student Research Team ({project.studentParticipants.length} Members)
              </h3>
              <p className="text-xs text-muted-foreground">
                Undergraduate & postgraduate researchers assigned to this solution
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="flex items-start gap-3 min-w-0">
                    ...
                    <div className="space-y-0.5 min-w-0">
                      ...
                      <p className="text-[10px] text-muted-foreground">Joined: {sp.joinedAt}</p>
                    </div>
                  </div>

                  <Badge
                    variant={sp.participationStatus === "lead" ? "default" : "secondary"}
